...
% 論文名稱
\newcommand{\chineseTitle}{可部署於量子退火器之矽光子元件反向設計：\\ 因數分解機代理模型最佳化}
\newcommand{\englishTitle}{Quantum-Annealer-Compatible Inverse Design of Silicon Photonic Devices Using Factorization-Machine Surrogate Optimization}
...
\input{Sections/5.Conclusion_and_FutureWork} \newpage
