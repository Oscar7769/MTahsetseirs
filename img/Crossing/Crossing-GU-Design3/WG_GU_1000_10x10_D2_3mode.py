...
def calculate_fom_from_partial(trans_res):
    ...
    return (err_T0 + err_T1 + err_T2 + err_C0 + err_C1 + err_C2) / 6.0
...
def parallel_evaluate(tasks, fom_cache, grid_rows, grid_cols):
    ...
    if size == 1:
        ...
        for task_idx, config, mode_name in tasks_to_run:
            ...
            if 'TE0' in partial_results[task_idx] and 'TE1' in partial_results[task_idx] and 'TE2' in partial_results[task_idx]:
